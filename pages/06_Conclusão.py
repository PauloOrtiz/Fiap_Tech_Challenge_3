...
st.markdown("""
    ...
    3. **Parcerias com Planos de Saúde**: Estabelecer parcerias estratégicas com provedores de planos de saúde para garantir tratamento oportuno, já que pela amostra da população estudada de infectados internados, apenas 28,24% possuíam este benefício;
